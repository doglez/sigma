...
import { createMaintenancePlanCrt } from "../../../redux/reducers/maintenancePlanReducers/maintenancePlanSlice.js";
        ...
        <div className="container">
            {!agreements[0] || !departments[0] ? (
                ...
                <Formik
                    ...
                    onSubmit={(values) => {
                        dispatch(createMaintenancePlanCrt(values));
